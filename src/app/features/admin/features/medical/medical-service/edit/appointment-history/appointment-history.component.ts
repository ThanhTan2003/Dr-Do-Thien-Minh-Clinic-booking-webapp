...
@Component({
  selector: 'app-medical-service-appointment-history',
...
export class MedicalServiceAppointmentHistoryComponent implements OnInit {
  serviceId: string = '';
  ...
  loadAppointments(page: number = 1): void {
    this.loading = true;
    this.appointmentService.getServiceAppointmentHistory(
      this.serviceId,
      '', // status
      this.keyword,
      page,
