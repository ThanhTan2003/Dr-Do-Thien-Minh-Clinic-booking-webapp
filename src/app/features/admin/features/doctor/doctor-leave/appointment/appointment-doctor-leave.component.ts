...
@Component({
    selector: 'app-appointment-doctor-leave',
    templateUrl: './appointment-doctor-leave.component.html',
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
...
export class AppointmentDoctorLeaveComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.route.params.subscribe(params => {
            this.doctorLeaveId = params['doctorLeaveId'];
    ...
    loadAppointments(): void {
        this.loading = true;
        this.appointmentScheduleService.searchAppointmentsForDoctorLeave(
            this.doctorLeaveId,
            this.keyword,
            this.currentPage,
            this.pageSize
