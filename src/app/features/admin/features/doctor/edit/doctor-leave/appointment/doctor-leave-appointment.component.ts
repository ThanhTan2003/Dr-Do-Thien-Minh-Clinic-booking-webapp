...
@Component({
    selector: 'app-doctor-leave-appointment',
    templateUrl: './doctor-leave-appointment.component.html',
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
...
export class DoctorLeaveAppointmentComponent implements OnInit {
